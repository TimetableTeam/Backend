...
const ALL_STAFF_ROLES = [ROLES.SUPER_ADMIN, ROLES.ADMIN, ROLES.SCHEDULER, ROLES.DEPARTMENT_COORDINATOR, ROLES.REGISTRATION_OFFICER, ROLES.LAB_MANAGER, ROLES.LECTURER, ROLES.TA];
